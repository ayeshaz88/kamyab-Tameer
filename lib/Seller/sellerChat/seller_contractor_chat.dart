...
class SellerContractorChatScreen extends StatefulWidget {
  @override
  _SellerContractorChatScreenState createState() => _SellerContractorChatScreenState();
}

class _SellerContractorChatScreenState extends State
{
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Contractor Chat', style: TextStyle(color: Colors.white)),
