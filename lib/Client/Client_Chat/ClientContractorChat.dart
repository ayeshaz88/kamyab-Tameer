...
class ClientSellerChatScreen extends StatefulWidget {
  @override
  _ClientSellerChatScreenState createState() => _ClientSellerChatScreenState();
}

class _ClientSellerChatScreenState extends State<ClientSellerChatScreen> {
