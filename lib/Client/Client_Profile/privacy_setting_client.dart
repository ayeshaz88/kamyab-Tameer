...
class PrivacySettingClientScreen extends StatefulWidget {
  @override
  _PrivacySettingClientScreenState createState() =>
      _PrivacySettingClientScreenState();
}

class _PrivacySettingClientScreenState
    extends State<PrivacySettingClientScreen> {
  String newPassword = '';
