...
class ContractorSellerChatScreen extends StatefulWidget {
  @override
  _ContractorSellerChatScreenState createState() => _ContractorSellerChatScreenState();
}

class _ContractorSellerChatScreenState extends State
{
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Seller', style: TextStyle(color: Colors.white)),
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final messageText = _seller[index];
