...
class PrivacyContScreen extends StatefulWidget {
  @override
  _PrivacyContScreenState createState() =>
      _PrivacyContScreenState();
}

class _PrivacyContScreenState
    extends State<PrivacyContScreen> {
  String newPassword = '';
