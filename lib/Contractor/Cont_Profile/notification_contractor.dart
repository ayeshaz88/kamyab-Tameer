...
class ContNotificationScreen extends StatefulWidget {
  const ContNotificationScreen({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _ContNotificationScreenState createState() => _ContNotificationScreenState();
}

class _ContNotificationScreenState extends State<ContNotificationScreen> {
