...
class ContFavoriteScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('favoriteproject').snapshots(),
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('Location: ${favoriteProject['location']}'),
