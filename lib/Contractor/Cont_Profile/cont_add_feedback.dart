...
class ConAddFeedbackScreen extends StatefulWidget {
  @override
  _ConAddFeedbackScreenState createState() => _ConAddFeedbackScreenState();
}

class _ConAddFeedbackScreenState extends State<ConAddFeedbackScreen> {
  ...
  void saveFeedback() {
    ...
    FirebaseFirestore.instance.collection('Contractorfeedback').add({
