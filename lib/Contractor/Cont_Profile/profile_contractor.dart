...
import 'package:kamiyabtameer/Contractor/Cont_Profile/cont_feedback.dart';
import 'package:kamiyabtameer/Contractor/Cont_Profile/favourits_contractor.dart';
import 'package:kamiyabtameer/Contractor/Cont_Profile/notification_contractor.dart';
import 'package:image_picker/image_picker.dart';
import '../../Client/Client_Profile/image_info_setting.dart';
import '../../Starting_Screen/login.dart';
import '../contractor_botton_nav.dart'; // Import the NotificationScreen file // Import the ImageInfoSettingScreen file

class ContProfileScreen extends StatelessWidget {
  const ContProfileScreen({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
                'Favourites', Icons.favorite, Icons.arrow_forward_ios, context),
            ...
            _buildSection(
                'Feedback', Icons.feedback, Icons.arrow_forward_ios, context),
            _buildSection(
        ...
        ListTile(
          ...
          onTap: () {
            ...
            if (label == 'Favourites') {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ContFavoriteScreen()),
              );
            }
            if (label == 'Notifications') {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const ContNotificationScreen()),
              );
            }
            if (label == 'Privacy') {
              // Navigator.push(context,
              // MaterialPageRoute(builder: (context) => PrivacySettingClientScreen()),);
            }
            if (label == 'Feedback') {
              Navigator.push(
                context,
